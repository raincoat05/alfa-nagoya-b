...
//暗転
data.push(new Sean('全員','？？！','background','null'));
...
data.push(new Sean('主人公','あなたは、ブランさんではない！だれだ！','noMonalisaround','blanc'));
data.push(new Sean('？？？','クックック...。ばれてしまったのか。ブランのやつもゆうしゅうな助手をやとったものだ。','noMonalisa','noir,blanc'));
...
data.push(new Sean('？？？','やめろ！私の助手に手を出すな！','noMonalisa','blanc'));
